...
### monitoring
sleep 5
docker-compose -f docker-compose-local-run.yaml up --detach prometheus grafana mutable-exporter todo-query-exporter todo-email-notifier-exporter keycloak-db-exporter secret-store-exporter kafka-exporter elasticsearch-exporter
