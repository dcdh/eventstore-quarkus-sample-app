...
docker build -f containers/debezium-connect-prometheus-exporter/Dockerfile -t damdamdeo/debezium-connect-prometheus-exporter:1.3.0.Final containers/debezium-connect-prometheus-exporter
docker build -f containers/debezium-zookeeper-prometheus-exporter/Dockerfile -t damdamdeo/debezium-zookeeper-prometheus-exporter:1.3.0.Final containers/debezium-zookeeper-prometheus-exporter
