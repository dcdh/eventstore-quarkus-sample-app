...
public final class DefaultTodoCreated implements TodoCreated {

    private final String todoId;
    private final String description;

    public DefaultTodoCreated(final String todoId, final String description) {
        this.todoId = todoId;
    ...
    public boolean equals(Object o) {
        ...
        DefaultTodoCreated that = (DefaultTodoCreated) o;
